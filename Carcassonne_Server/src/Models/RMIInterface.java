...
public interface RMIInterface extends Remote {
	 ...
	 *
	 * @param naam Geef de gebruikersnaam van de speler mee
	 ...
	 *
	 * @return Er wordt een arraylist(int) teruggegeven die de scores van alle spelers bevat
	 * @throws RemoteException RemoteException wordt gegooid wanneer er iets mis gaat met de RMI verbinding
	 */
	 ...
	 *
	 * @param jsonFile Geef een Json-based save file mee
	 * @throws RemoteException RemoteException wordt gegooid wanneer er iets mis gaat met de RMI verbinding
	 */
	 ...
	 *
	 * @param spelerNaam Geef de gebruikersnaam van de speler mee
	 ...
	 *
	 * @param x Geef de X co-ordinaat mee waar de kaart op geplaatst moet worden
	 * @param y Geef de y co-ordinaat mee waar de kaar op geplaatst moet worden
	 * @return Geeft true terug als de kaart geplaatst is, geeft false terug als de kaart niet geplaatst
	 ...
	 *
	 * @param naam Geef de naam van de speler mee in de vorm van een String
	 * @return Geeft een true terug wanneer de kaart is gedraait, een false als dit niet is gelukt
	 ...
	 *
	 * @return Geeft een int terug met het aantal kaarten dat nog in de stapel zit
	 * @throws RemoteException RemoteException wordt gegooid wanneer er iets mis gaat met de RMI verbinding
	 */
	 ...
	 *
	 * @param path Geef het path mee in de vorm van een String
	 * @return placeholder
	 * @throws RemoteException RemoteException wordt gegooid wanneer er iets mis gaat met de RMI verbinding
	 */
	 ...
	 *
	 * @param posities Geef de positie mee
	 * @return Geeft true terug wanneer de horige succesvol geplaatst is, en false wanneer dit niet zo is
	 * @throws RemoteException RemoteException wordt gegooid wanneer er iets mis gaat met de RMI verbinding
	 */
	 ...
	 *
	 * @return ArrayList met alle horige posities
	 * @throws RemoteException RemoteException wordt gegooid wanneer er iets mis gaat met de RMI verbinding
	 */
